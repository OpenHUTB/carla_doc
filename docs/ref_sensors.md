...
*   __输出：__ [carla.CAMData](python_api.md#carla.CAMData), 根据 ETSI CAM (European Telecommunications Standards Institute , Cooperative Awareness Message，欧洲通信标准协会，协同警示消息) 标准触发，除非另有配置
