...
Carla 仿真器还可用作评估和测试环境。您可以部署在仿真中训练过的自动驾驶代理来测试和评估其性能和安全性，所有这些都在模拟环境的安全范围内，不会对硬件或其他道路使用者造成风险。
...
除了车辆之外，Carla 还提供行人添加到模拟中，以仿真真实的驾驶场景。在 Carla 术语中，车辆和行人被称为参与者，请在 [__此处__](core_actors.md) 了解有关它们的更多信息。
